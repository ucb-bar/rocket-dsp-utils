...
class AXI4DspQueue(val depth: Int, val baseAddr: BigInt = 0, concurrency: Int = 4)(implicit p: Parameters)
    extends AXI4RegisterRouter(baseAddr, beatBytes = 8, concurrency = concurrency)(new AXI4RegBundle(depth, _))(
...
class AHBDspQueue(val depth: Int, val baseAddr: BigInt = 0, concurrency: Int = 4)(implicit p: Parameters)
    extends AHBRegisterRouter(baseAddr, beatBytes = 8, concurrency = concurrency)(new AHBRegBundle(depth, _))(
...
class APBDspQueue(val depth: Int, val baseAddr: BigInt = 0, concurrency: Int = 4)(implicit p: Parameters)
    extends APBRegisterRouter(baseAddr, beatBytes = 8, concurrency = concurrency)(new APBRegBundle(depth, _))(
