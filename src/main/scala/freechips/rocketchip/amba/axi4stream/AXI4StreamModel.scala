...
object DoubleToBigIntRand {
  implicit def apply(r: Rand[Double]): Rand[BigInt] =
    new Rand[BigInt] {
...
trait AXI4StreamModel[T <: Module] extends AXI4StreamSlaveModel[T] with AXI4StreamMasterModel[T] {
