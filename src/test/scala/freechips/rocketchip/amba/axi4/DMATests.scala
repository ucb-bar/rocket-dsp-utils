...
//  with AXI4StreamModel[dut.module.type] {
//
//  val mod = dut.module
...
//    lazy val lazyDut = LazyModule(new StreamingAXI4DMAWithMemory(
...
//    lazy val lazyDut = LazyModule(new StreamingAXI4DMAWithCSRWithScratchpad(
...
//      lazy val dma = LazyModule(new StreamingAXI4DMAWithCSRWithScratchpad(
//        csrAddress = AddressSet(0x400, 0xFF),
//        scratchpadAddress = AddressSet(0x0, 0x3FF),
//        beatBytes = 8,
//      ))
//      lazy val pbus = LazyModule(new PeripheryBus(PeripheryBusParams(
//        beatBytes = 16,
//        blockBytes = 16 * 8,
//        atomics = None,
//      ), "periphery_bus"))
...
//      }
//    }
//    lazy val lazyDut = LazyModule(new WithPBUS with TLStandaloneBlock {
